...
WebUI.click(findTestObject('Object Repository/Page_Hc liu - Sch Mm/a_Kim th 2019'))
...
WebUI.verifyElementNotVisible(findTestObject('Page_Hc liu - Sch Mm/div_Qun l lp hc'))

WebUI.click(findTestObject('Object Repository/Page_Hc liu - Sch Mm/i_Thng bo_fa fa-lg fa-bars_1'))
